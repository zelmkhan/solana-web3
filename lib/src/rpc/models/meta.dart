...
class Meta extends Serializable {
  ...
  factory Meta.fromJson(final Map<String, dynamic> json) => Meta(
    ...
    innerInstructions: IterableSerializable.tryFromJson(json['innerInstructions'], InnerInstruction.fromJson),
    preTokenBalances: IterableSerializable.tryFromJson(json['preTokenBalances'], TokenBalance.fromJson),
    postTokenBalances: IterableSerializable.tryFromJson(json['postTokenBalances'], TokenBalance.fromJson),
